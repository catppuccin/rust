...
fn main() {
    ...
    let ansi_normal_magenta = catppuccin::PALETTE.mocha.ansi_colors.magenta.normal;
    let ansi_bright_magenta = catppuccin::PALETTE.mocha.ansi_colors.magenta.bright;
